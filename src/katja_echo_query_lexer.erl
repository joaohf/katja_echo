...
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 104 ->
    yystate(13, Ics, Line, Tlen+1, 1, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 116 ->
    yystate(13, Ics, Line, Tlen+1, 1, Tlen);
...
yyaction_1(TokenChars, TokenLine) ->
     { token, { keyword, TokenLine, list_to_atom (TokenChars) } } .
